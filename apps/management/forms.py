...
class BuildingForm(forms.ModelForm):
    class Meta:
        model = Building
        fields = ['name', 'details', 'capacity', 'photo']
        widgets = {
            ...
            'details': forms.Textarea(attrs={
                ...
                'rows': 4,
                'placeholder': 'Enter building description here',
            }),
...
class BatchForm(forms.ModelForm):
    class Meta:
        model = Batch
        fields = [ 'breed', 'building','status', 'arrival_date', 'arrival_age', 'arrival_quantity', 'details']
        widgets = {
            ...
            'arrival_age': forms.NumberInput(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'placeholder': 'Arrival age (Days)',
            }),
            ...
            'details': forms.Textarea(attrs={
                'class': 'block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'rows': 4,
                'placeholder': 'Enter batch details here',
            }),
        }
...
class DailyLogForm(forms.ModelForm):
    class Meta:
        model = DailyLog
        fields = ['log_date', 'living_quantity', 'deceased_quantity', 'sick_quantity', 'details']
        widgets = {
            'log_date': forms.DateInput(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'type': 'date',
            }),
            'living_quantity': forms.NumberInput(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'placeholder': 'Living quantity',
            }),
            'deceased_quantity': forms.NumberInput(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'placeholder': 'Deceased quantity',
            }),
            'sick_quantity': forms.NumberInput(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'placeholder': 'Sick quantity',
            }),
            'details': forms.Textarea(attrs={
                'class': 'block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'rows': 4,
    ...
    def clean_log_date(self):
        ...
        if log_date > date.today():
            raise forms.ValidationError("The log date cannot be in the future.")
        return log_date
...
class StockLossForm(forms.ModelForm):
    class Meta:
        model = StockLoss
        fields = ['feed', 'loss_date', 'quantity', 'reason', 'details']
        widgets = {
            'feed': forms.Select(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white',
            }),
            'loss_date': forms.DateInput(attrs={
                'type': 'date',
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
            }),
...
class FeedingForm(forms.ModelForm):
    class Meta:
        model = Feeding
        fields = [ 'feeding_date', 'quantity', 'feed_type', 'details']
        widgets = {
            
            'feeding_date': forms.DateInput(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'type': 'date',
            }),
            'quantity': forms.NumberInput(attrs={
...
class EggCollectionForm(forms.ModelForm):
    class Meta:
        model = EggCollection
        fields = [ 'collection_date' ,'quantity', 'craked', 'details']
        widgets = {
            ...
            'craked': forms.NumberInput(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'placeholder': 'Quantity',
            }),
            'details': forms.Textarea(attrs={
...
class ProvisionForm(forms.ModelForm):
    class Meta:
        model = Provision
        fields = ['supplier', 'feed', 'quantity', 'provision_date']
        widgets = {
            ...
            'provision_date': forms.DateInput(attrs={
                'class': 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'type': 'date',
            }),
        }
...
class ExpenseForm(forms.ModelForm):
    class Meta:
        model = Expense
        fields = ['category', 'supplier', 'batch', 'details', 'amount']
        widgets = {
            ...
            'details': forms.Textarea(attrs={
                'class': 'block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
                'rows': 4,
                'placeholder': 'Enter charge description here',
            }),
